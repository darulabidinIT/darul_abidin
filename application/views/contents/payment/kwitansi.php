...
<table width="100%">
    ...
    <tr>
        <td width="10%">Kembali</td><td width="3%">:</td><td width="30%" style="font-size:11pt;"><b><?php echo Rupiah($datapay['kembali'])?></b></td><td align="center"><span style="color:grey;font-size:8pt;">-nama-</span></td><td align="center">Ragita</td>
    </tr>
</table>
