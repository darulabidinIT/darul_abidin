...
<div class="alert alert-success" role="alert">
 ...
 <div class="col-md-12">
			   ...
			   <div class="col-sm-3">
				   ...
				   <?php echo form_dropdown($nm_f,$opt_ta,(isset($val[$nm_f]) ? $val[$nm_f] : ''),"class='select2' id='tahun_ajaran' onchange='gantita(this.value)'")?>
			   </div>
		   </div>
			   ...
			   <div class="col-sm-3">
				   ...
				   <?php echo form_dropdown($nm_f,$opt_kelas,(isset($val[$nm_f]) ? $val[$nm_f] : ''),"class='select2' onchange='changejenjang(this.value)' id='$nm_f' required")?>
			   </div>
		   </div>
                   <!--div class="form-group" style="margin-bottom:20px!important;">
